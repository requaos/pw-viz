...
let
  nixifiedLockHash = "95c68e004109dea610e903214439a5948de9f577c31958b05ec733cdaf85ba73";
...
in
{
  ...
  workspace = {
    pw-viz = rustPackages.unknown.pw-viz."0.2.3";
  };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".async-executor."1.7.2" = overridableMkRustCrate (profileName: rec {
    name = "async-executor";
    version = "1.7.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "fc5ea910c42e5ab19012bab31f53cb4d63d54c3a27730f9a833a88efcf4bb52d"; };
    dependencies = {
      async_lock = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".async-lock."3.1.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".async-io."2.2.0" = overridableMkRustCrate (profileName: rec {
    name = "async-io";
    version = "2.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "41ed9d5715c2d329bf1b4da8d60455b99b187f27ba726df2883799af9af60997"; };
    dependencies = {
      async_lock = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".async-lock."3.1.1" { inherit profileName; }).out;
      cfg_if = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."1.0.0" { inherit profileName; }).out;
      concurrent_queue = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".concurrent-queue."2.3.0" { inherit profileName; }).out;
      ...
      futures_lite = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-lite."2.0.1" { inherit profileName; }).out;
      parking = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking."2.2.0" { inherit profileName; }).out;
      polling = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".polling."3.3.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".async-lock."3.1.1" = overridableMkRustCrate (profileName: rec {
    name = "async-lock";
    version = "3.1.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "655b9c7fe787d3b25cc0f804a1a8401790f0c5bc395beb5a64dc77d8de079105"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "std" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".async-process."1.8.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      event_listener = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".event-listener."3.1.0" { inherit profileName; }).out;
      futures_lite = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-lite."1.13.0" { inherit profileName; }).out;
      ${ if hostPlatform.isUnix then "rustix" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustix."0.38.25" { inherit profileName; }).out;
      ${ if hostPlatform.isWindows then "windows_sys" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows-sys."0.48.0" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".async-signal."0.2.5" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.isUnix then "async_io" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".async-io."2.2.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".eframe."0.23.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "bytemuck" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytemuck."1.14.0" { inherit profileName; }).out;
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "egui_winit" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".egui-winit."0.23.0" { inherit profileName; }).out;
      egui_glow = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".egui_glow."0.23.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".egui-winit."0.23.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.kernel.name == "android") then "arboard" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".arboard."3.3.0" { inherit profileName; }).out;
      egui = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".egui."0.23.0" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.20" { inherit profileName; }).out;
      ...
      web_time = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".web-time."0.2.3" { inherit profileName; }).out;
  ...
  "git+https://github.com/Ax9D/egui_nodes".egui_nodes."0.1.4" = overridableMkRustCrate (profileName: rec {
    name = "egui_nodes";
    version = "0.1.4";
    registry = "git+https://github.com/Ax9D/egui_nodes";
    src = fetchCrateGit {
      url = https://github.com/Ax9D/egui_nodes;
      name = "egui_nodes";
      version = "0.1.4";
      rev = "27167e4b77e5c306e35d9d65ec7eb310cd25bc4f";};
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".epaint."0.20.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ahash = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ahash."0.8.6" { inherit profileName; }).out;
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "atomic_refcell" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".atomic_refcell."0.1.13" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libspa."0.7.2" = overridableMkRustCrate (profileName: rec {
    name = "libspa";
    version = "0.7.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0434617020ddca18b86067912970c55410ca654cdafd775480322f50b857a8c4"; };
    dependencies = {
      bitflags = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."2.4.1" { inherit profileName; }).out;
      convert_case = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".convert_case."0.6.0" { inherit profileName; }).out;
      cookie_factory = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cookie-factory."0.3.2" { inherit profileName; }).out;
      libc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.150" { inherit profileName; }).out;
      spa_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libspa-sys."0.7.2" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libspa-sys."0.7.2" = overridableMkRustCrate (profileName: rec {
    name = "libspa-sys";
    version = "0.7.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b3e70ca3f3e70f858ef363046d06178c427b4e0b63d210c95fd87d752679d345"; };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pipewire."0.7.2" = overridableMkRustCrate (profileName: rec {
    name = "pipewire";
    version = "0.7.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a2d009c8dd65e890b515a71950f7e4c801523b8894ff33863a40830bf762e9e9"; };
    dependencies = {
      anyhow = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.75" { inherit profileName; }).out;
      bitflags = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."2.4.1" { inherit profileName; }).out;
      libc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.150" { inherit profileName; }).out;
      spa = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libspa."0.7.2" { inherit profileName; }).out;
      spa_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libspa-sys."0.7.2" { inherit profileName; }).out;
      nix = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".nix."0.26.4" { inherit profileName; }).out;
      once_cell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.18.0" { inherit profileName; }).out;
      pw_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".pipewire-sys."0.7.2" { inherit profileName; }).out;
      thiserror = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.50" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".pipewire-sys."0.7.2" = overridableMkRustCrate (profileName: rec {
    name = "pipewire-sys";
    version = "0.7.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "890c084e7b737246cb4799c86b71a0e4da536031ff7473dd639eba9f95039f64"; };
    dependencies = {
      spa_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libspa-sys."0.7.2" { inherit profileName; }).out;
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".polling."3.3.0" = overridableMkRustCrate (profileName: rec {
    name = "polling";
    version = "3.3.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e53b6af1f60f36f8c2ac2aad5459d75a5a9b4be1e8cdd40264f315d78193e531"; };
    dependencies = {
      cfg_if = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."1.0.0" { inherit profileName; }).out;
      ${ if hostPlatform.isWindows then "concurrent_queue" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".concurrent-queue."2.3.0" { inherit profileName; }).out;
      ${ if hostPlatform.isWindows then "pin_project_lite" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-lite."0.2.13" { inherit profileName; }).out;
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "fuchsia" || hostPlatform.parsed.kernel.name == "vxworks" then "rustix" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustix."0.38.25" { inherit profileName; }).out;
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.40" { inherit profileName; }).out;
      ${ if hostPlatform.isWindows then "windows_sys" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows-sys."0.48.0" { inherit profileName; }).out;
    };
  });
  ...
  "unknown".pw-viz."0.2.3" = overridableMkRustCrate (profileName: rec {
    name = "pw-viz";
    version = "0.2.3";
    registry = "unknown";
    src = fetchCrateLocal workspaceSrc;
    dependencies = {
      eframe = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".eframe."0.23.0" { inherit profileName; }).out;
      egui = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".egui."0.23.0" { inherit profileName; }).out;
      egui_nodes = (rustPackages."git+https://github.com/Ax9D/egui_nodes".egui_nodes."0.1.4" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.20" { inherit profileName; }).out;
      natord = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".natord."1.0.9" { inherit profileName; }).out;
      pipewire = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".pipewire."0.7.2" { inherit profileName; }).out;
      rand = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.8.5" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.193" { inherit profileName; }).out;
      simple_logger = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".simple_logger."4.2.0" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".simple_logger."4.2.0" = overridableMkRustCrate (profileName: rec {
    name = "simple_logger";
    version = "4.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2230cd5c29b815c9b699fb610b49a5ed65588f3509d9f0108be3a885da629333"; };
    features = builtins.concatLists [
      [ "colored" ]
      [ "colors" ]
      [ "default" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".web-time."0.2.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if false then "js_sys" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.65" { inherit profileName; }).out;
      ${ if false then "wasm_bindgen" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen."0.2.88" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".zbus."3.14.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      async_executor = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".async-executor."1.7.2" { inherit profileName; }).out;
